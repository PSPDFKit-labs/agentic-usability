...
function LogsPanel({ logs }: { logs: LogFiles | null }) {
  ...
  const entries: { label: string; content: string | null; filename: string }[] = [
    ...
    { label: 'Agent Egress Log', content: logs.agentProxyLog, filename: 'agent-egress.log.json' },
    ...
    { label: 'Judge Egress Log', content: logs.judgeProxyLog, filename: 'judge-egress.log.json' },
