...
export interface AgentAdapter {
  ...
  /** Env var name for overriding the API base URL (e.g. "ANTHROPIC_BASE_URL"). Null for custom agents. */
  readonly baseUrlEnvVar: string | null;
  /** Default API key env var name (e.g. "ANTHROPIC_API_KEY"). Null for custom agents. */
